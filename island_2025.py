...
# Function to unpack binary vectors
...
# results_folder = repo_id + '/umap/cosine'
...
# # Get the 2025 file
# parquet="bluuebunny/arxiv_abstract_embedding_mxbai_large_v1_milvus/data/2025.parquet"
...
# Initiate the reducer
reducer = umap.UMAP(metric='hamming', n_components=3)

# Get the 2025 file
parquet="bluuebunny/arxiv_abstract_embedding_mxbai_large_v1_milvus_binary/data/2025.parquet"
print(f'Processing {parquet}')
